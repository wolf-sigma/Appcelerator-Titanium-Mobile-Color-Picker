...
// in simulator we redefine to format for colorPicker Developer console
...
{\
	NSString * exceptionName = [@"org.colorpicker." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.colorpicker";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UIcolorPickerNativeItemNone = -1, 
	UIcolorPickerNativeItemSpinner = -2,
	UIcolorPickerNativeItemProgressBar = -3,
	
	UIcolorPickerNativeItemSlider = -4,
	UIcolorPickerNativeItemSwitch = -5,
	UIcolorPickerNativeItemMultiButton = -6,
	UIcolorPickerNativeItemSegmented = -7,
	
	UIcolorPickerNativeItemTextView = -8,
	UIcolorPickerNativeItemTextField = -9,
	UIcolorPickerNativeItemSearchBar = -10,
	
	UIcolorPickerNativeItemPicker = -11,
	UIcolorPickerNativeItemDatePicker = -12,
	
	UIcolorPickerNativeItemInfoLight = -13,
	UIcolorPickerNativeItemInfoDark = -14,
	
	UIcolorPickerNativeItemDisclosure = -15,
	
	UIcolorPickerNativeItemContactAdd = -16
};
